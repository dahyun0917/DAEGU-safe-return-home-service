...
#### ✔️ 목적
  - 공공데이터를 활용해 범죄 위험도가 높은 골목을 분석 및 선정하고, 이를 활용한 어플리케이션을 개발을 통해 시민의 불안감 개선 및 입지 추천에 활용할 수 있습니다.
...
#### 3️⃣ 신고 서비스<br>
  ...
  - 사용자가 신고 버튼 클릭 시, 보호자 연락처로 신고자의 현재 위치를 전송합니다.<br>
...
#### 4️⃣ 귀가 모니터링<br>
  - 출발지와 목적지 입력 후 길찾기 버튼 클릭 시, NaverMap 길찾기 API를 통해 경로가 지도에 표시됩니다.<br>
